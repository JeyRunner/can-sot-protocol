...
When you compiled canSot (either directly or by including it as a dependency), you get a `canSotCli` executable in your `build` folder.
...
flowchart TD
    ...
    B --> |canSotCli genProtocolSpec ...| C(myprotocol.h)
```
